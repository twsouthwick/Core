...
namespace Castle.DynamicProxy.Tests
{
	...
	public class InterceptorSelectorTestCase : BasePEVerifyTestCase
	{
		...
		public void When_two_selectors_present_and_not_equal_should_cache_type_anyway_InterfaceProxyWithoutTarget()
		{
			...
			var proxy1 = generator.CreateInterfaceProxyWithoutTarget(typeof(IOne), Type.EmptyTypes, options1,
				new SetReturnValueInterceptor(2));
			var proxy2 = generator.CreateInterfaceProxyWithoutTarget(typeof(IOne), Type.EmptyTypes, options2,
				new SetReturnValueInterceptor(2));
		...
		{
			var someInstanceOfProxyWithoutSelector =
				(IService2)generator.CreateInterfaceProxyWithoutTarget(typeof(IService2), new DoNothingInterceptor());
			var someInstanceOfProxyWithSelector =
				(IService2)generator.CreateInterfaceProxyWithoutTarget(typeof(IService2), new ProxyGenerationOptions
				{
		...
		{
			var someInstanceOfProxyWithoutSelector =
				(IService2)generator.CreateInterfaceProxyWithTarget(typeof(IService2), new Service2(), new StandardInterceptor());
			var someInstanceOfProxyWithSelector =
				(IService2)generator.CreateInterfaceProxyWithTarget(typeof(IService2), new Service2(),
		...
		public void Can_proxy_same_type_with_and_without_selector_InterfaceProxyWithTargetInterface()
		{
			var someInstanceOfProxyWithoutSelector =
				(IService2)
					generator.CreateInterfaceProxyWithTargetInterface(typeof(IService2), new Service2(), new StandardInterceptor());
			var someInstanceOfProxyWithSelector =
				(IService2)generator.CreateInterfaceProxyWithTargetInterface(typeof(IService2), new Service2(),
					new ProxyGenerationOptions { Selector = new AllInterceptorSelector() },
					new StandardInterceptor());
		...
		{
			var someInstanceOfProxyWithoutSelector =
				(Component2)generator.CreateClassProxy(typeof(Component2), new StandardInterceptor());
		...
		{
			var someInstanceOfProxyWithoutSelector =
				(Component2)generator.CreateClassProxyWithTarget(typeof(Component2), new Component2(), new StandardInterceptor());
			var someInstanceOfProxyWithSelector =
				(Component2)generator.CreateClassProxyWithTarget(typeof(Component2), new Component2(),
					new ProxyGenerationOptions { Selector = new AllInterceptorSelector() },
					new StandardInterceptor());
		...
		{
			var someInstanceOfProxyWithSelector1 =
				(IService2)generator.CreateInterfaceProxyWithTarget(typeof(IService2), new Service2(),
					new ProxyGenerationOptions { Selector = new SelectorWithState(1) },
					new StandardInterceptor());
			var someInstanceOfProxyWithSelector2 =
				(IService2)generator.CreateInterfaceProxyWithTarget(typeof(IService2), new Service2(),
		...
		public void Cannot_proxy_generic_interface_with_type_argument_that_has_inaccessible_type_argument()
		{
			var exception =
				Assert.Throws<GeneratorException>(
					() =>
						generator.CreateInterfaceProxyWithTarget<IList<IList<PrivateInterface>>>(new List<IList<PrivateInterface>>(),
							new IInterceptor[0]));
		}
	...
	public class FakeProxy
	{
		...
		public virtual int Do()
		{
			...
			{
				interceptors_Do = __selector.SelectInterceptors(TypeUtil.GetTypeOrNull(__target), token_Do, __interceptors) ??
				                  new IInterceptor[0];
			}
	...
	{
		public ISimpleInterface_Do(SimpleClass simpleClass, FakeProxy fakeProxy, IInterceptor[] interceptorsDo,
			MethodInfo tokenDo, object[] objArray)
		{
